...
function BulletPoint({
  ...
  children: React.ReactNode;
  type?: 'default' | 'allowed' | 'forbidden';
}) {
  const colors = {
    default: Colors.cta,
    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      >
        ...
        >
          ...
          <Text style={[styles.paragraph, styles.warning]}>{t('termsOfService.appNature.medicalDisclaimer')}</Text>
        </TermsSection>
        ...
        >
          ...
          {isFossEffective && (
            <Text style={[styles.paragraph, styles.highlight]}>{t('termsOfService.versions.currentFoss')}</Text>
          )}
          {isFossSimulated && (
            <Text style={[styles.paragraph, styles.warning]}>{t('termsOfService.versions.currentFossSimulated')}</Text>
          )}
        </TermsSection>
        ...
        >
          ...
          <BulletPoint>{t('termsOfService.optionalServices.social.hosting')}</BulletPoint>
          <BulletPoint>{t('termsOfService.optionalServices.social.crossBorder')}</BulletPoint>
        ...
        >
          ...
          <Text style={[styles.paragraph, styles.warning]}>{t('termsOfService.socialRules.warning')}</Text>
        </TermsSection>
