...
import { HealthConnectSettingsSheet, type HealthConnectSettingsSheetRef } from '../components/sheets';
...
import type { HealthConnectWorkout, SpixWorkoutType, HealthConnectWeight } from '../services/healthConnect';
import { calculateQuestTotals, calculateXpForEntry } from '../stores/gamificationStore';
                    ...
                    {workouts.length === 0 && weights.length === 0 ? (
                        <View style={styles.emptyContainer}>
                            <Image 
                                ...
                                alt={t('healthConnect.emptyTitle')}
